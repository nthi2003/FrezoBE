...
public class MenuController {
    ...
    @Operation(summary = "Lấy menu theo người dùng", description = "Bootstrap FE menu — KHÔNG gắn @CheckPermission (tránh deadlock UI). Vẫn cần JWT (authenticated).")
    ...
    @GetMapping
    @CheckPermission(api = "/qtht/menu", action = "VIEW")
    ...
    @GetMapping("/{id}")
    @CheckPermission(api = "/qtht/menu/{id}", action = "VIEW")
    ...
    @PostMapping
    @CheckPermission(api = "/qtht/menu", action = "CREATE")
    ...
    @PutMapping("/{id}")
    @CheckPermission(api = "/qtht/menu/{id}", action = "UPDATE")
    ...
    @DeleteMapping("/{id}")
    @CheckPermission(api = "/qtht/menu/{id}", action = "DELETE")
