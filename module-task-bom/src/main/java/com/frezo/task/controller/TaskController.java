...
public class TaskController {
    ...
    @PostMapping
    @CheckPermission(api = "/task/task", action = "CREATE")
    ...
    @PutMapping("/{id}")
    @CheckPermission(api = "/task/task/{id}", action = "UPDATE")
    ...
    @DeleteMapping("/{id}")
    @CheckPermission(api = "/task/task/{id}", action = "DELETE")
    ...
    @GetMapping("/{id}")
    @CheckPermission(api = "/task/task/{id}", action = "VIEW")
    ...
    @GetMapping
    @CheckPermission(api = "/task/task", action = "VIEW")
    ...
    @CheckPermission(api = "/task/task/{id}/assign/{assigneeId}", action = "UPDATE")
    ...
    @CheckPermission(api = "/task/task/{id}/status", action = "UPDATE")
    ...
    @CheckPermission(api = "/task/task/{id}/review", action = "UPDATE")
